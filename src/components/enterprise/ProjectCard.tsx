...
export default function ProjectCard({ project, canModerate, canDelete, onDelete }: ProjectCardProps) {
    ...
    return (
        ...
        >
            <div className="absolute top-0 left-0 w-1 h-full bg-[#1E88E5] opacity-0 group-hover:opacity-100 transition-opacity" />
                ...
                <div className="flex justify-between items-start">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h3 className="text-sm font-black text-slate-900 tracking-tight leading-none mt-1  truncate max-w-[140px] group-hover:text-[#1E88E5] transition-colors">{project.name}</h3>
                        </div>
                    </div>
