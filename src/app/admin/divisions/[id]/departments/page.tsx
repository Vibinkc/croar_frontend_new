        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Manage Departments under this Division</p>
                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex gap-4 pt-4 border-t border-slate-100">
                                    ...
                                    <button
                                        ...
                                        className="flex-1 px-4 py-3 rounded-xl bg-slate-900 text-white text-xs font-black uppercase tracking-widest hover:bg-slate-800 transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
