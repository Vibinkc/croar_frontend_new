            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h1 className="text-2xl font-black text-slate-900 tracking-tight  leading-none">Inject Protocol</h1>
                    </div>
                </div>
            ...
            <div className="bg-white shadow-sm sm:rounded-2xl p-4 border border-slate-100">
                ...
                {activeTab === "MANUAL" && (
                    <form onSubmit={(e) => handleManualSubmit(e)} className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {['A', 'B', 'C', 'D'].map((opt) => (
                                <div key={opt} className="space-y-2">
                                    <label className="block text-[10px] font-black text-slate-400  ">Option {opt}</label>
                                    <div className="relative">
                                        ...
                                        <button
                                            ...
                                            className={`absolute inset-y-2 right-2 px-4 rounded-xl text-[10px] font-black   transition-all ${correctOption === opt
                        ...
                        <div className="space-y-2">
                            <label className="block text-[10px] font-black text-slate-400  ">Protocol Logic / Explanation</label>
                            <input
                                type="text"
                                value={explanation}
                        ...
                        <div className="flex justify-end pt-8 border-t border-slate-100 gap-4">
                            ...
                            <button
                                type="submit"
                                className="px-10 py-3.5 bg-slate-900 text-white rounded-2xl text-[10px] font-black  tracking-[0.2em] hover:bg-slate-800 shadow-xl shadow-slate-200 transition-all flex items-center gap-3 active:scale-95"
                            >
                    ...
                    <form onSubmit={handleBulkUpload} className="space-y-8">
                            ...
                            <div className="relative z-10 space-y-4">
                                ...
                                <div className="space-y-2">
                                    <label htmlFor="file-upload" className="cursor-pointer">
                                        <p className="text-lg font-black text-slate-900  tracking-tight">Stream Data Pack</p>
                                        <p className="text-[10px] font-black text-slate-400  ">Excel, CSV, or XLSM (Max 10MB)</p>
                        ...
                        <div className="flex justify-end pt-8 border-t border-slate-100">
                            <button
                                ...
                                className="px-10 py-3.5 bg-slate-900 text-white rounded-2xl text-[10px] font-black  tracking-[0.2em] hover:bg-slate-800 shadow-xl shadow-slate-200 transition-all flex items-center gap-3 active:scale-95 disabled:opacity-50"
                            >
                                {uploading ? (
                                    <>
                        ...
                        <div className="bg-slate-50/50 p-8 rounded-[2rem] border border-slate-100">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h4 className="text-[10px] font-black text-slate-900  tracking-[0.2em]">Protocol Mapping Standards</h4>
                            </div>
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                {[
                                    ...
                                    <div key={guide.k} className="flex flex-col">
                                        <span className="text-[9px] font-black text-slate-400   mb-1">{guide.k}</span>
                    ...
                    <div className="space-y-12">
                        <form onSubmit={handleAIGenerate} className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div className="space-y-2">
                                    <label className="block text-[10px] font-black text-slate-400  ">Protocol Domain</label>
                                    <select
                                        value={type}
                                ...
                                <div className="space-y-2">
                                    <label className="block text-[10px] font-black text-slate-400  ">Protocol Count</label>
                                    <input
                                        type="number"
                                        min={1}
                                        max={20}
                                ...
                                <div className="space-y-2">
                                    <label className="block text-[10px] font-black text-slate-400  ">Target Sector</label>
                                    <div className="flex flex-col gap-3">
                                        <select
                                            value={topic}
                                            onChange={(e) => setTopic(e.target.value)}
                            ...
                            <div className="space-y-4">
                                <label className="block text-[10px] font-black text-slate-400   text-center">Neural Complexity Synthesis</label>
                                <div className="flex justify-center gap-6">
                                    {["EASY", "MEDIUM", "HARD"].map((diff) => (
                                        <label key={diff} className="relative flex items-center gap-3 cursor-pointer group">
                                            ...
                                            <span className={`text-[10px] font-black   transition-colors ${aiDifficulties.includes(diff) ? 'text-slate-900' : 'text-slate-400'}`}>
                                                {diff}
                                            </span>
                                        </label>
                                    ))}
                            ...
                            <div className="bg-indigo-50/50 p-8 rounded-[2.5rem] border border-indigo-100 flex items-center gap-6">
                                ...
                                <div>
                                    <h4 className="text-sm font-black text-slate-900  tracking-tight mb-1">Neural Engine Intelligence</h4>
                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-700">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl font-black text-slate-900  tracking-tight ">Staging Area</h3>
                                <p className="text-[10px] font-black text-slate-400   mt-1">Pending Review: {draftQuestions.length} Protocols</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
                            <button
                                ...
                                className="px-6 py-3.5 bg-slate-50 text-slate-500 rounded-2xl text-[10px] font-black   hover:bg-rose-50 hover:text-rose-600 transition-all disabled:opacity-30 flex items-center gap-3"
                            >
                            ...
                            <button
                                ...
                                className="px-8 py-3.5 bg-emerald-500 text-white rounded-2xl text-[10px] font-black  tracking-[0.1em] hover:bg-emerald-600 shadow-xl shadow-emerald-100 transition-all disabled:opacity-50 flex items-center gap-3 active:scale-95"
                            >
                                {isSavingBulk ? (
                                    <>
                                ...
                                <div className="flex gap-6">
                                    ...
                                    <div className="flex-1 space-y-8">
                                        ...
                                        <div className="space-y-6">
                                            <div className="space-y-2">
                                                <label className="text-[9px] font-black text-slate-300  ">Question Text</label>
                                                <textarea
                                                        ...
                                                        <div key={opt} className="relative group/opt">
                                                            <div className={`flex items-center gap-3 p-4 rounded-2xl border transition-all ${draft.correct_answer.answer === opt ? 'bg-emerald-50 border-emerald-100' : 'bg-white border-slate-50 group-hover/opt:border-slate-200'}`}>
                                                                ...
                                                                <button
                                                                    ...
                                                                    className={`px-3 py-1 rounded-lg text-[8px] font-black   transition-all ${draft.correct_answer.answer === opt ? 'bg-emerald-500 text-white' : 'opacity-0 group-hover/opt:opacity-100 bg-slate-100 text-slate-400 hover:bg-slate-200'}`}
                                                                >
                                                                    Correct
                                                                </button>
                                                            </div>
