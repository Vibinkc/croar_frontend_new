...
function InterviewAttemptList({ interviewId }: { interviewId: string }) {
    ...
    if (loading) return (
        <div className="flex flex-col items-center justify-center p-20 animate-in fade-in duration-500">
            ...
            <p className="text-[10px] font-black  tracking-[0.3em] text-slate-400">Loading_Interview_Data</p>
        </div>
    );
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-black text-slate-900  tracking-tighter mb-2">Interview Session Results</h1>
                    <p className="text-xs font-bold text-slate-400  ">Interview ID: {interviewId}</p>
                </div>
            </div>
                            ...
                            {attempts.length === 0 && (
                                <tr>
                                    <td colSpan={5} className="p-12 text-center text-slate-300">
                                        ...
                                        <p className="text-[10px] font-black  tracking-[0.2em]">No_Interviews_Recorded</p>
                                    </td>
                                </tr>
                            )}
                        </tbody>
