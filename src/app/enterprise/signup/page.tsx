            ...
            <div className="hidden lg:flex lg:w-1/2 bg-slate-900 relative overflow-hidden items-center justify-center p-12">
                ...
                <div className="relative z-10 max-w-lg text-center">
                    <div className="w-20 h-20 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl mx-auto mb-8 flex items-center justify-center shadow-2xl shadow-indigo-500/30">
                        <span className="material-icons-outlined text-4xl text-white">business</span>
                    </div>
                    <h1 className="text-4xl font-bold text-white mb-6">Join Croar Enterprise</h1>
                ...
                <div className="max-w-md w-full bg-white dark:bg-slate-900 p-10 rounded-xl shadow-xl border border-slate-100 dark:border-slate-800">
                    {signupEnabled === null ? (
                        <div className="text-center py-20">
                            ...
                            <p className="mt-4 text-slate-500 font-bold">Verifying System Status...</p>
                        </div>
                    ) : signupEnabled === false ? (
                        <div className="text-center py-12 px-4">
                            <div className="w-20 h-20 bg-rose-50 text-rose-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-inner">
                                <span className="material-icons-outlined text-4xl">block</span>
                            </div>
                            <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-3 tracking-tight">Registration Closed</h3>
                            ...
                            <Link 
                                ...
                                className="inline-flex items-center justify-center px-8 py-3 bg-slate-900 text-white font-bold rounded-xl hover:bg-slate-800 transition-all shadow-xl"
                            >
                                Back to Login
                            </Link>
                        </div>
                        ...
                        <>
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 disabled:opacity-50 text-white font-bold rounded-xl shadow-lg shadow-indigo-200 dark:shadow-none transition-all transform active:scale-95 flex items-center justify-center gap-2 mt-4"
                            >
                                {loading ? (
                            ...
                            <p className="text-center text-sm text-slate-500 mt-6">
                                ...
                                <Link href="/enterprise/login" className="text-indigo-600 font-bold hover:underline">
                                    Sign In
                                </Link>
                            </p>
                        </form>
