                ...
                <div className="max-w-md w-full bg-white p-9 rounded-[14px] border border-[#E8EAED] shadow-[0_4px_14px_rgba(15,23,42,0.05)]">
                    ...
                    {signupEnabled === null ? (
                        <div className="text-center py-20">
                            ...
                            <p className="mt-4 text-[#8A929E] font-semibold">{tr("auth.verifyingSystem")}</p>
                        </div>
                    ) : signupEnabled === false ? (
                        <div className="text-center py-12 px-4">
                            ...
                            <h3 className="text-[24px] font-extrabold text-[#15171C] mb-3 tracking-[-0.4px]">{tr("auth.registrationClosed")}</h3>
                        ...
                        <div className="text-center py-8">
                            ...
                            <h3 className="text-[20px] font-extrabold text-[#15171C] tracking-[-0.3px] mb-2">{tr("auth.accountCreated")}</h3>
                            <p className="text-[#8A929E]">{tr("auth.redirectingLogin")}</p>
                        </div>
                    ) : (
                        <>
                            <div className="mb-7">
                                <h2 className="text-[24px] font-extrabold tracking-[-0.4px] text-[#15171C] mb-1.5">{tr("auth.createAccount")}</h2>
                                <p className="text-[#8A929E] text-sm">{tr("auth.setupOrg")}</p>
                            </div>
                            <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label htmlFor="first-name" className="block text-[12.5px] font-semibold text-[#374151] mb-1.5">{tr("auth.firstName")}</label>
                                    <input
                                        id="first-name"
                                ...
                                <div>
                                    <label htmlFor="last-name" className="block text-[12.5px] font-semibold text-[#374151] mb-1.5">{tr("auth.lastName")}</label>
                                    <input
                                        id="last-name"
                                        className="w-full h-11 px-3.5 bg-white border border-[#E1E4E8] rounded-[10px] text-[14px] text-[#15171C] placeholder:text-[#9AA3AF] focus:outline-none focus:border-[#5B53E0] focus:ring-2 focus:ring-[#5B53E0]/20 transition-all"
                                        type="text"
                            ...
                            <div>
                                <label htmlFor="company-name" className="block text-[12.5px] font-semibold text-[#374151] mb-1.5">{tr("auth.companyName")}</label>
                                <div className="relative">
                            ...
                            <div>
                                <label htmlFor="work-email" className="block text-[12.5px] font-semibold text-[#374151] mb-1.5">{tr("auth.workEmail")}</label>
                                <div className="relative">
                            ...
                            <div>
                                <label htmlFor="password" className="block text-[12.5px] font-semibold text-[#374151] mb-1.5">{tr("auth.password")}</label>
                                <div className="relative">
