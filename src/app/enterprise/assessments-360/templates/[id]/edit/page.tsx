        ...
        <div className="min-h-screen bg-slate-50/50">
            <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-slate-200 py-4 px-8 flex justify-between items-center">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-slate-900 tracking-tight leading-none mb-1">Refine 360 Framework</h1>
                        <p className="text-slate-500 text-xs font-medium">Optimizing professional competencies for feedback cycles</p>
                    </div>
                </div>
                <div className="flex gap-3">
                    ...
                    >
                        {submitting ? 'Updating...' : 'Update Framework'}
                    </button>
                </div>
            </header>
            ...
            <main className="max-w-6xl mx-auto p-8 lg:p-12 space-y-12 animate-in fade-in duration-700">
                ...
                <section className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-2xl shadow-slate-200/50 space-y-10 relative overflow-hidden">
                    ...
                    <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-10">
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] px-1">Organization Context</label>
                            <input 
                                className="w-full px-6 py-4 bg-slate-50 border-2 border-transparent rounded-2xl focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-100 outline-none text-sm font-bold text-slate-700 placeholder:text-slate-300 transition-all h-[60px]"
                ...
                <section className="space-y-10">
                    <div className="flex justify-between items-center px-2">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl font-black text-slate-900 tracking-tight">Competency Refinement</h3>
                                <p className="text-slate-500 text-[10px] font-bold uppercase tracking-widest mt-0.5">Adjust competencies for specific organizational needs</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
                ...
                <div className="pt-20 flex flex-col items-center border-t border-slate-100 pb-32">
                    <div className="flex flex-col items-center mb-10 text-center max-w-sm">
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-4">Final Architecture</p>
                        <h4 className="text-2xl font-black text-slate-900 mb-2">{formData.question_ids.length} Questions Configured</h4>
                        <p className="text-slate-500 text-xs font-medium">Verify your selection and competency weightings before finalizing the update.</p>
                    </div>
                    <button 
                        onClick={handleSave}
                        disabled={submitting || formData.question_ids.length === 0}
                        ...
                        <div className="p-8 space-y-6">
                            <div className="space-y-2">
                                ...
                                <input 
                                    ...
                                    placeholder="e.g. High-Tech, Social, Retail..."
                                    autoFocus
                                />
                                <p className="text-[10px] text-slate-400 font-medium px-1 italic">Generated items will reflect industry nuances.</p>
                            </div>
                            <button 
