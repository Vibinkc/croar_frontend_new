            ...
            <main className="max-w-6xl mx-auto p-8 lg:p-12 space-y-12 animate-in fade-in duration-700">
                    ...
                    <div className="flex justify-between items-center px-2">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-500 text-[10px] font-bold   mt-0.5">Adjust competencies for specific organizational needs</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
                ...
                <div className="pt-20 flex flex-col items-center border-t border-slate-100 pb-32">
                    <div className="flex flex-col items-center mb-10 text-center max-w-sm">
                        <p className="text-[10px] font-black text-slate-400  tracking-[0.3em] mb-4">Final Architecture</p>
                        ...
                        <div className="p-8 space-y-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    autoFocus
                                />
                                <p className="text-[10px] text-slate-400 font-medium px-1 ">Generated items will reflect industry nuances.</p>
                            </div>
                            <button 
