...
function LoginFallback() {
    const { t: tr } = useI18n();
    return <div className="min-h-screen bg-[#F5F6F8] flex items-center justify-center text-[#757575] font-semibold">{tr("auth.loading")}</div>;
}
        ...
        <div className={`flex min-h-screen bg-[#F5F6F8] text-[#212121] ${hankenGrotesk.className}`}>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8">
                <div className="max-w-md w-full bg-white p-9 rounded-[4px] border border-[#E0E0E0] shadow-[0_4px_14px_rgba(0,0,0,0.05)]">
                    ...
                    <div className="mb-8">
                        <h2 className="text-[24px] font-extrabold tracking-[-0.4px] text-[#212121] mb-1.5">{tr("auth.welcomeBack")}</h2>
                        <p className="text-[#757575] text-sm">{tr("auth.signInSubtitle")}</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-1.5">
                                <label className="block text-[12.5px] font-semibold text-[#424242]" htmlFor="password">
                                    {tr("auth.password")}
                                </label>
                                <Link
                                    href="/enterprise/forgot-password"
                                    className="text-[12.5px] font-semibold text-[#1976D2] hover:text-[#1565C0] transition-colors"
                                >
                        ...
                        <button
                            type="submit"
                            className="w-full h-[46px] bg-[#1976D2] hover:bg-[#1565C0] text-white font-bold text-[14.5px] rounded-[4px] shadow-[0_6px_16px_rgba(25,118,210,0.28)] transition-colors flex items-center justify-center gap-2"
                        >
                    ...
                    {signupEnabled && (
                        <p className="text-center text-sm text-[#757575] mt-7">
                            {tr("auth.noAccount")}{" "}
                            <Link href="/enterprise/signup" className="text-[#1976D2] font-semibold hover:underline">
                                {tr("auth.createOne")}
                            </Link>
                        </p>
                    )}
