                ...
                {isLoading ? (
                    ...
                    <>
                        <div className="hidden md:grid grid-cols-[2.4fr_2fr_1fr_120px] gap-4 px-5 py-3 bg-[#FAFAFA] border-b border-[#E0E0E0]">
                            <span className="text-[11px] font-semibold uppercase tracking-[0.04em] text-[#757575]">{t("superAdmin.colAdmin")}</span>
                                ...
                                >
                                    <div className="flex items-center gap-3 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <span className="block text-[12px] text-[#757575] truncate md:hidden">{admin.email}</span>
                                        </div>
                                    </div>
