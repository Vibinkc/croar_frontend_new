    ...
    if (isLoading) return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center">
            <div className="flex flex-col items-center gap-4">
                ...
                <span className="text-[10px] font-black tracking-[0.3em] text-slate-400 uppercase">Synchronizing_Assignments</span>
            </div>
        </div>
    );
            ...
            <section className="relative overflow-hidden rounded-[1.5rem] bg-rose-600 p-6 text-white shadow-lg">
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="space-y-3">
                        <h2 className="text-2xl font-black uppercase tracking-tight">AI Interview Hub</h2>
                    ...
                    <div className="flex items-center gap-4 bg-white/10 p-4 rounded-xl backdrop-blur-md border border-white/20 min-w-[140px]">
                        ...
                        <div>
                            <p className="text-[9px] font-black text-slate-100 uppercase tracking-widest mb-1">Pending_Interviews</p>
                            <div className="flex items-baseline gap-1">
                                <span className="text-2xl font-black">{interviews.length}</span>
                                <span className="text-[9px] font-bold text-white uppercase">Sessions</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {interviews.length === 0 && (
                <div className="bg-white rounded-[2.5rem] p-20 border border-slate-100 flex flex-col items-center justify-center text-center space-y-6">
                    ...
                    <div className="space-y-2">
                        <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight">Queue_Empty</h2>
